...
public:
  ...
  jubatus::util::lang::shared_ptr<future<typename Function::result_type> > async(Function f) {
  ...
  template<typename Function>
  std::vector<jubatus::util::lang::shared_ptr<future<typename Function::result_type> > >
...
namespace default_thread_pool {
  ...
  template<typename Function>
  std::vector<jubatus::util::lang::shared_ptr<thread_pool::future<typename Function::result_type> > >
  async_all(const std::vector<Function>& funcs) {
