...
#ifndef JUBATUS_CORE_NEAREST_NEIGHBOR_COLUMN_TABLE_NEAREST_NEIGHBOR_BASE_HPP_
#define JUBATUS_CORE_NEAREST_NEIGHBOR_COLUMN_TABLE_NEAREST_NEIGHBOR_BASE_HPP_
...
class column_table_nearest_neighbor_base : public nearest_neighbor_base {
 public:
  explicit column_table_nearest_neighbor_base(
      jubatus::util::lang::shared_ptr<storage::column_table> table,
      const std::string& id);
  virtual ~column_table_nearest_neighbor_base() {}
  ...
  void delete_row(const std::string& id);
...
#endif  // JUBATUS_CORE_NEAREST_NEIGHBOR_COLUMN_TABLE_NEAREST_NEIGHBOR_BASE_HPP_
